...
INSERT INTO Attendees (idprof, name, surname, phone, city, postcode, street) VALUES (
	2, 'Kamil', 'Cecherz', '+48 798 996 422', '£ódŸ', '96-018', 'Powstañców Wielkopolskich 24/17'
);

INSERT INTO Attendees (idprof, name, surname, phone, city, postcode, street) VALUES (
	3, '£ukasz', 'Bednarski', '+48 786 207 883', '£êczyca', '99-100', 'Ozorkowska 9'
);

INSERT INTO Attendees (idprof, name, surname, phone, city, postcode, street) VALUES (
	4, 'Adam', 'Wolniewicz', '+48 693 044 971', '£ódŸ', '90-001', 'Komandorska 3/2'
);

INSERT INTO Attendees (idprof, name, surname, phone, city, postcode, street) VALUES (
	5, 'Adam', 'Kowalewski', '+48 602 732 532', 'Tomaszów Mazowiecki', '97-200', 'G³owackiego 19a/55'
);

INSERT INTO Attendees (idprof, name, surname, phone, city, postcode, street) VALUES (
	6, 'Rados³aw', 'Ignasiak', '+48 506 601 295', '£ódŸ', '90-001', 'Leopolda Tyrmanda 104/22'
);

INSERT INTO Attendees (idprof, name, surname, phone, city, postcode, street) VALUES (
	7, 'Ma³gorzata', 'WlaŸlak', '+48 796 141 420', 'Warszawa', '02-321', 'Aleje Jerozolimskie 107a/3'
);
...
INSERT INTO Courses (title, start_date, end_date, describtion, max_attende) VALUES (
    'Analiza danych tekstowych i jêzyka naturalnego (Python)',
    '2019-07-10 12:30:00',
    '2019-07-13 17:00:00',
    'Nauczenie szeregu narzêdzi do pracy z danymi tekstowymi, przedstawienie szeregu
	przyk³adów u¿ycia pokrywaj¹cych wiêkszoœæ tematów tej dziedziny.',
    10
);

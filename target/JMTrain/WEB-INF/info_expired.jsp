...
<div class="container">
    <div class="row bs-callout bs-callout-primary">
        <div class="col col-md-12 col-sm-12">
            <button class="btn btn-warning btn-warning" disabled="disabled" style="padding: 20px; font-size: 30px; width: 100%">Twój link wygasł !</button>
            <br />
            <br />
            <p class="btn-warning" disabled="disabled" style="text-align: center; padding: 10px;">
                Link jest nieaktywny gdyż wygasł, być może konto zostało już aktywowane wcześniej.<br />
                Spróbuj zalogować się do systemu.
            </p>
        </div>
    </div>
</div>
